...
public class Sport extends Event {
    ...
    public Sport(String event_name, LocalDate event_date, LocalTime event_time, String venue_name, int total_seats, double ticket_price, String event_type, String sportName, String teamsName){
